...
/* Datos: personalízalos si quieres */
const hardSkills = [
  {
    key: 'vue',
    title: 'Vue.js 3',
    desc: 'Componentes reusables, Composition API, optimización de rendimiento',
    icon: `<svg width="36" height="36" viewBox="0 0 24 24" fill="none"><path d="M12 2 3 21h6l3-6 3 6h6L12 2z" fill="url(#g)"/><defs><linearGradient id="g" x1="0" x2="1"><stop offset="0" stop-color="#6ee7b7"/><stop offset="1" stop-color="#7c5cff"/></linearGradient></defs></svg>`
  },
  {
    key: 'git',
    title: 'Git',
    desc: 'Control de versiones, branches, pull requests y buenas prácticas de commit',
    icon: `<svg width="36" height="36" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" fill="#f05032"/></svg>`
  },
  {
    key: 'seo',
    title: 'Optimización SEO',
    desc: 'Meta tags, rendimiento, accesibilidad y buenas prácticas on-page',
    icon: `<svg width="36" height="36" viewBox="0 0 24 24" fill="none"><rect x="3" y="3" width="18" height="18" rx="4" fill="#6ee7b7"/></svg>`
  },
  {
    key: 'ux',
    title: 'UX',
    desc: 'Diseño centrado en el usuario, prototipado y pruebas de usabilidad',
    icon: `<svg width="36" height="36" viewBox="0 0 24 24" fill="none"><path d="M4 12h16M12 4v16" stroke="#7c5cff" stroke-width="1.6" /></svg>`
  },
  {
    key: 'webdev',
    title: 'Web Development',
    desc: 'HTML5, CSS3 (Grid/Flex), JS ES6+, rendimiento y accesibilidad',
    icon: `<svg width="36" height="36" viewBox="0 0 24 24" fill="none"><rect x="3" y="4" width="18" height="16" rx="2" fill="#9aa3ad"/></svg>`
  }
]
...
const softSkills = [
  {
    ...
    icon: `<svg width="36" height="36" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" fill="#7c5cff"/></svg>`
  },
  {
    key: 'team',
    title: 'Trabajo en equipo',
    desc: 'Cooperación, empatía y responsabilidad en entregas',
    icon: `<svg width="36" height="36" viewBox="0 0 24 24" fill="none"><path d="M4 20v-2a4 4 0 0 1 4-4h8a4 4 0 0 1 4 4v2" fill="#6ee7b7"/></svg>`
  },
  {
    key: 'problem',
    title: 'Resolución de problemas',
    desc: 'Enfoque analítico y búsqueda de soluciones prácticas',
    icon: `<svg width="36" height="36" viewBox="0 0 24 24" fill="none"><path d="M12 2v6" stroke="#6ee7b7" stroke-width="1.6"/></svg>`
  },
  {
    key: 'adapt',
    title: 'Adaptabilidad',
    desc: 'Aprendizaje rápido y flexibilidad ante cambios de requerimientos',
    icon: `<svg width="36" height="36" viewBox="0 0 24 24" fill="none"><path d="M12 2c2 2 4 4 6 6" stroke="#9aa3ad" stroke-width="1.6"/></svg>`
  }
]
</script>
...
/* carousel area similar al de proyectos */
.carousel-area{
  display:flex;
  align-items:center;
  gap:12px;
...
@media(min-width:900px){
  .skill-card{ min-width:240px; max-width:240px }
}
</style>
